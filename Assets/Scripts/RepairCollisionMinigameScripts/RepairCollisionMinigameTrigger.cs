...
public class RepairCollisionMinigame : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (hint == null)
        {
            Debug.LogError("RepairCollisionMinigame: hint is NOT assigned in Inspector.");
            return;
        }
    ...
    private void ShowPopup()
    {
        if (popupPanel == null)
        {
            Debug.LogError("RepairCollisionMinigame: popupPanel is NOT assigned in Inspector");
            return;
        }
